class UsersController < ApplicationController
  ...
  #   # Never trust parameters from the scary internet, only allow the white list through.
    def user_params
      params.require(:user).permit(:first_name, :facebook, :twitter, :pinterest, :email, :avatar, :verified, :password, :password_confirmation, :last_name, :username, :list_id, :description, :picture)
    end
end
